 ...
 * new TipView.Builder(MainActivity.this, (ViewGroup) findViewById(R.id.zone), (int) OldListX + view.getWidth() / 2, (int) OldListY + view.getHeight())
 *         .addItem(new TipView.TipItem("复制"))
 *         .addItem(new TipView.TipItem("转发"))
 *         .addItem(new TipView.TipItem("删除"))
 *         .setOnItemClickListener(new TipView.OnItemClickListener() {
 *             public void onItemClick(String str, final int position) {
 *                 Toast.makeText(MainActivity.this, position + " : " + str, Toast.LENGTH_SHORT).show();
 *             }
 *
 *             public void dismiss() {
